...
const ComponentMain = () => {
  return (
    <div className="container">
      ...
      <button className="btn btn-primary" style={{marginRight: "3px"}}>Default</button>
      <button className="btn btn-outline-primary" style={{marginRight: "3px"}}>outline</button>
      <button className="btn btn-primary rounded" style={{marginRight: "3px"}}>Rounded</button>
      <button className="btn btn-primary rounded" style={{marginRight: "3px"}}><i className="ti-thumb-up pr-1"></i> With Icon</button>
      <button className="btn btn-primary circle"><i className="ti-heart"></i></button>

      <h6 className="section-secondary-title mt-5">Sizes :</h6>
      <button className="btn btn-primary btn-lg" style={{marginRight: "3px"}}>Large</button>
      <button className="btn btn-primary " style={{marginRight: "3px"}}>Regular</button>
      <button className="btn btn-primary btn-sm" style={{marginRight: "3px"}}>Small</button>
      <button className="btn btn-primary w-sm ml-3" style={{marginRight: "3px"}}>w-sm</button>
      <button className="btn btn-primary w-md" style={{marginRight: "3px"}}>w-md</button>
      <button className="btn btn-primary w-lg">w-lg</button>

      <h6 className="section-secondary-title mt-5">Colors :</h6>          
      <button type="button" className="btn btn-primary" style={{marginRight: "3px"}}>Primary</button>
      <button type="button" className="btn btn-secondary" style={{marginRight: "3px"}}>Secondary</button>
      <button type="button" className="btn btn-success" style={{marginRight: "3px"}}>Success</button>
      <button type="button" className="btn btn-danger" style={{marginRight: "3px"}}>Danger</button>
      <button type="button" className="btn btn-warning" style={{marginRight: "3px"}}>Warning</button>
      <button type="button" className="btn btn-info" style={{marginRight: "3px"}}>Info</button>
      <button type="button" className="btn btn-light" style={{marginRight: "3px"}}>Light</button>
      <button type="button" className="btn btn-dark">Dark</button>

      <h6 className="section-secondary-title mt-5">Buttons Tags :</h6>
      <button className="btn btn-primary" type="submit" style={{marginRight: "3px"}}>Button</button>
      <input className="btn btn-primary" type="button" value="Input" style={{marginRight: "3px"}} />
      <input className="btn btn-primary" type="submit" value="Submit" style={{marginRight: "3px"}} />
      ...
      <div className="row mt-5">
         <div className="col-md-6">
            ...
            <div className="form-group">
               <textarea className="form-control" id="exampleFormControlTextarea1" rows="3" placeholder="Example textarea"></textarea>
            </div>
         </div>
         <div className="col-md-6">
      ...
      <div className="btn-group">
         <button type="button" className="btn btn-outline-secondary">Split</button>
      ...
      <div className="btn-group">
         ...
         <div className="dropdown-menu form">
            ...
            <div className="dropdown-divider"></div>
            <a className="dropdown-item" href="/#"><small>New around here? Sign up</small></a>
            <a className="dropdown-item" href="/#"><small>Forgot password?</small></a>
         </div>
      </div>       
      ...
      {/* Navbars  */}
      <h3 className="components-section-title font-weight-normal mt-5">Navigations</h3>
      <hr />
         ...
         <div className="container">
            ...
            <div className="collapse navbar-collapse" id="navbarSupportedContent">
               <ul className="navbar-nav ml-auto"> 
                  ...
                  <li className="nav-item">
                     <a href="/#book-table" className="ml-4 mt-1 btn btn-light btn-sm">navbar button</a>
                  </li>
               </ul>                       
            </div>
         </div>
      ...
      <nav className="navbar navbar-expand-sm navbar-dark bg-secondary rounded shadow mb-3">
         <div className="container">
            <a className="navbar-brand" href="/#">Secondary Color</a>
            <button className="navbar-toggler ml-auto" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
            <span className="navbar-toggler-icon"></span>
            </button>
            <div className="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <nav className="navbar navbar-expand-sm navbar-dark bg-dark rounded shadow mb-3">
         <div className="container">
            <a className="navbar-brand" href="/#">Dark Color</a>
            <button className="navbar-toggler ml-auto" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
            <span className="navbar-toggler-icon"></span>
            </button>
            <div className="collapse navbar-collapse" id="navbarSupportedContent">
               <ul className="navbar-nav ml-auto"> 
                  ...
                  <li className="nav-item">
                     <a href="/#book-table" className="ml-4 mt-1 btn btn-primary btn-sm">navbar button</a>
                  </li>
               </ul>                       
            </div>
         </div>
         ...
         <div className="container">
            ...
            <div className="collapse navbar-collapse" id="navbarSupportedContent">
               <ul className="navbar-nav ml-auto"> 
                  ...
                  <li className="nav-item">
                     <a href="/#book-table" className="ml-4 mt-1 btn btn-dark btn-sm">navbar button</a>
                  </li>
               </ul>                       
            </div>
         </div>
      ...
      <div className="row justify-content-between">
         <div className="col-md-5">
            <h3 className="components-section-title font-weight-normal mt-5">Progress Bars :</h3>
            <hr/>
            <small>Default: </small>
         ...
         <div className="col-md-6">
            <h3 className="components-section-title font-weight-normal mt-5">Paginations :</h3>
            <hr/>
            <nav aria-label="Page navigation example">
               <ul className="pagination pagination-sm">
                  <li className="page-item"><a className="page-link" href="/#"><i className="ti-angle-double-left"></i></a></li>
                  <li className="page-item"><a className="page-link" href="/#">1</a></li>
                  <li className="page-item"><a className="page-link" href="/#">2</a></li>
                  <li className="page-item active"><a className="page-link" href="/#">3</a></li>
                  <li className="page-item"><a className="page-link" href="/#">4</a></li>
                  <li className="page-item"><a className="page-link" href="/#">5</a></li>
                  <li className="page-item"><a className="page-link" href="/#"><i className="ti-angle-double-right"></i></a></li>
               </ul>
            </nav>
            <nav aria-label="Page navigation example">
            ...
            {/* Badges  */}
            <h3 className="components-section-title font-weight-normal mt-5">Badges :</h3>
            <hr/>
      ...
      {/* Alerts  */}
      <h3 className="components-section-title font-weight-normal mt-5">Alerts :</h3>
      <hr/>
      ...
      <table className="table table-borderless v-align-center">
         <tbody>
            <tr>
               <td>
                  <p><code className="highlighter-rouge">&lt;h1&gt;&lt;/h1&gt; || .h1</code></p>
               </td>
               <td className="w-75"><span className="h1">h1. Bootstrap heading</span></td>
            </tr>
            <tr>
               <td>
                  <p><code className="highlighter-rouge">&lt;h2&gt;&lt;/h2&gt; || .h2</code></p>
               </td>
               <td><span className="h2">h2. Bootstrap heading</span></td>
            </tr>
            <tr>
               <td>
                  <p><code className="highlighter-rouge">&lt;h3&gt;&lt;/h3&gt; || .h3</code></p>
               </td>
               <td><span className="h3">h3. Bootstrap heading</span></td>
            </tr>
            <tr>
               <td>
                  <p><code className="highlighter-rouge">&lt;h4&gt;&lt;/h4&gt; || .h4</code></p>
               </td>
               <td><span className="h4">h4. Bootstrap heading</span></td>
            </tr>
            <tr>
               <td>
                  <p><code className="highlighter-rouge">&lt;h5&gt;&lt;/h5&gt; || .h5</code></p>
               </td>
               <td><span className="h5">h5. Bootstrap heading</span></td>
            </tr>
            <tr>
               <td>
                  <p><code className="highlighter-rouge">&lt;h6&gt;&lt;/h6&gt; || .h6</code></p>
               </td>
            ...
            <tr>
               <td><p className="font-weight-bold text-muted">Ordred List :</p></td>
               <td>
                  <ol>
            ...
            <tr>
               <td><p className="font-weight-bold text-muted">Unordred List :</p></td>
               <td>
                  <ul >
                     <li>Integer molestie lorem at massa</li>
                     <li>Facilisis in pretium nisl aliquet</li>
            ...
            <tr>
               <td><p className="font-weight-bold text-muted">Unstyled List :</p></td>
               <td>
            ...
            <tr>
               ...
               <td>
                  <p className="text-muted">Lorem ipsum dolor sit amet, consectetur adipisicing elit. In, nulla, reprehenderit! Beatae, dolor harum fugiat.</p>
               </td>
            </tr>
            <tr>
               <td>
               ...
               <td>
                  <p className="text-primary">Lorem ipsum dolor sit amet, consectetur adipisicing elit. In, nulla, reprehenderit! Beatae, dolor harum fugiat.</p>
               </td>
            </tr>
            <tr>
               <td>
               ...
               <td>
                  <p className="text-danger">Lorem ipsum dolor sit amet, consectetur adipisicing elit. In, nulla, reprehenderit! Beatae, dolor harum fugiat.</p>
               </td>
            </tr>
            <tr>
               <td>
               ...
               <td>
                  <p className="text-warning">Lorem ipsum dolor sit amet, consectetur adipisicing elit. In, nulla, reprehenderit! Beatae, dolor harum fugiat.</p>
               </td>
            </tr>
            <tr>
               <td>
               ...
               <td>
                  <p className="text-success">Lorem ipsum dolor sit amet, consectetur adipisicing elit. In, nulla, reprehenderit! Beatae, dolor harum fugiat.</p>
               </td>
            </tr>
            <tr>
               <td>
               ...
               <td>
                  <p className="text-info">Lorem ipsum dolor sit amet, consectetur adipisicing elit. In, nulla, reprehenderit! Beatae, dolor harum fugiat.</p>
               </td>
            </tr>
         </tbody>
      </table>
